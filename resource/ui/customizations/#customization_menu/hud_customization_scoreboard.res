...
// Spanish -------------------------------------------------------------------------------------------------------------------------------
					"Scoreboard_Spanish"
					{
						...
						"Scoreboard_Image"
						{
							...
							"scaleImage"				"1"
							"proportionaltoparent"		"1"
							"image"						"replay/thumbnails/customizations/scoreboard/scoreboard_spanish"
						}
						"Scoreboard_Button"
						{
							"ControlName"				"CExButton"
							...
							"enabled"					"1"
							"font"						""
							"command"					"engine scoreboard_spanish"
							"labeltext"					""
							"sound_depressed"			"UI/buttonclick.wav"
							"proportionaltoparent"		"1"
							"actionsignallevel"			"6"
					...
					"Separator2"
					{
						...
						"pin_to_sibling"				"Scoreboard_Spanish"
						"pin_corner_to_sibling"			"PIN_BOTTOMLEFT"
						"pin_to_sibling_corner"			"PIN_BOTTOMRIGHT"
					}
// Foster --------------------------------------------------------------------------------------------------------------------------------
